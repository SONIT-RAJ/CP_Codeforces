...
vector<bool>f(vector<int>&a,vector<int>&b,int &n){
    vector<bool>val(n,false);
    vector<int>mpp(n+1,-1);
    vector<int>nge(n);
    vector<int>pse(n);
    stack<int>s;
    for(int i=n-1;i>=0;i--){
...
void solve(){
    ...
    vector<int>b(n);
    cin>>b;
    vector<bool>v1=f(a,b,n);
    reverse(a.begin(),a.end());
    reverse(b.begin(),b.end());
    vector<bool>v2=f(a,b,n);
