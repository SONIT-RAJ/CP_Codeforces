...
void solve(){
    ...
    if(f0 && fn && fp){
        ...
        for(int i=1;i<p.size();i++){
            cout<<1<<" "<<p[i].second<<" "<<p[0].second<<endl;
        }
        int sz=neg.size();
        if(sz%2==0){
            for(int i=0;i<sz;i++){
                cout<<1<<" "<<neg[i].second<<" "<<p[0].second<<endl;
            }
        }
        else{
            ...
            cout<<1<<" "<<neg[sz-1].second<<" "<<z[0].second<<endl;
        }
        ...
        if(sz%2==0){
            for(int i=1;i<sz;i++){
                cout<<1<<" "<<neg[i].second<<" "<<neg[0].second<<endl;
            }
            cout<<2<<" "<<z[0].second<<endl;
        }
        else if(sz==1){
            cout<<2<<" "<<neg[0].second<<endl;
        }
        else{
